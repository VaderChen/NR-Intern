...
- Thinking 단계를 선택할 수 있습니다. Session 계획은 잠가서 순차 실행하거나 잠금을 해제해 병렬 실행할 수 있습니다.
...
- 공식 GitHub Release 버전 업데이트 확인. 알림 센터를 켜면 새 버전이 알림 센터에 들어가며 동일 버전은 중복 알림하지 않습니다.
...
- 모델에 맞춰 간소／확장 도구 집합, 도구 검색, native／instruction 도구 호출 방식을 선택할 수 있습니다.
