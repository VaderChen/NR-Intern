...
- 메모리 격리 프로젝트: Project 설정은 유지하면서 대화, 계획 및 작업 파일을 앱 종료 또는 재시작 시 삭제합니다. 각 Project는 용량을 설정할 수 있는 전용 RAM 디스크 Sandbox를 사용합니다. 이런 프로젝트의 도구 호출은 매번 승인을 묻지 않으며, 새로 만들기는 실험적 기능에서 끌 수 있습니다(기본 켜짐). 기존 프로젝트는 영향을 받지 않습니다.
